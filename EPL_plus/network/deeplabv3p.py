...
class SingleNetwork(nn.Module):
    def __init__(self, num_classes, criterion, norm_layer, in_channels=1, pretrained_model=None):
        ...
        # self.representation = nn.Conv2d(256, 256, kernel_size=1, bias=True)
    ...
    def forward(self, data):
        ...
        # pred1 = F.interpolate(pred, size=(h, w), mode='bilinear', align_corners=True)
        # pred2 = F.interpolate(pred, size=(1, 1), mode='bilinear', align_corners=True)
        ...
        rep = self.representation(v3plus_feature)
